...
const chatCases = [
  ...
  // Round 18 (2026-09-04): the request-boundary envelopes the review found unmeasured.
  ['response_format text with a stray json_schema', { messages: M, response_format: { type: 'text', json_schema: { name: 'x', schema: { type: 'object' } } } }],
  ['response_format json_object with a stray json_schema', { messages: M, response_format: { type: 'json_object', json_schema: { name: 'x', schema: { type: 'object' } } } }],
  ['tools function with a whitespace-only name', { messages: M, tools: [{ type: 'function', function: { name: '   ', parameters: { type: 'object', properties: {} } } }] }],
  ['legacy function with a blank name', { messages: M, reasoning_effort: 'none', functions: [{ name: '', parameters: { type: 'object', properties: {} } }] }],
  ['legacy function_call naming an undeclared function', { messages: M, reasoning_effort: 'none', functions: [{ name: 'real', parameters: { type: 'object', properties: {} } }], function_call: { name: 'never_declared' } }],
  ['tool_choice auto with tools absent', { messages: M, reasoning_effort: 'none', tool_choice: 'auto' }],
  ['tool_choice none with tools absent', { messages: M, reasoning_effort: 'none', tool_choice: 'none' }],
...
const responsesCases = [
  ...
  ['responses text.format text with a stray schema', { ...OUT, text: { format: { type: 'text', schema: { type: 'object' } } } }],
  ['responses text.format json_object with a stray schema', { ...OUT, text: { format: { type: 'json_object', schema: { type: 'object' } } } }],
  ['responses tools function with a whitespace-only name', { ...OUT, tools: [{ type: 'function', name: '   ', parameters: { type: 'object', properties: {} } }] }],
